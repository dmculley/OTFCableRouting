...
class CableCostGA(object):
    ...
    def __init__(self, substation_location = [[0,0]], capacity = 7, pop_size = 80, num_iter = 200, convergence_definition = 20, converged = False, show_prog = False, show_result = False): 
    ...
    def run_GA(self, turbine_locations):
    ...
    def compute_cable_cost(self, turbine_locations):
        out = self.run_GA(turbine_locations)
        self.best_chromosome = out[0]
        return out[1]
        
    def compute_cable_cost_derivative(self, turbine_locations):
        dC_dX = self.differentiate(self.best_chromosome, turbine_locations)
        return dC_dX
...
#    turbine_locations = [(1,1),(1.3,3.4),(1.5,4.6),(2.2,2.8),(2.1,3.1),(2.2,4.3),(3.4,2.5),(3.6,3.7),(3.8,4.9),(4.1,2.2),(4.3,3.4),(4.5,4.6),(5.7,2.6),(5.9,3.1),(5.2,4.3),(6.4,2.5),(6.6,3.7),(6.8,4.9)]
    ...
    print CC.compute_cable_cost(turbine_locations)
    print CC.compute_cable_cost_derivative(turbine_locations)
